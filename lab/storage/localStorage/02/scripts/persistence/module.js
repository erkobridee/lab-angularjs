(function() {
  ...
  /*
    Based on Ben Nadel code, reorganized
    https://gist.github.com/bennadel/cba13cbb2fcd03b7f788#file-localstorage-htm-L253-L485
    https://github.com/bennadel/JavaScript-Demos/tree/master/demos/local-storage-angularjs
  */

  var module = angular.module('persistence', []);

  module.value('STORAGE_KEY', 'persistence_keepsaved');
  ...
  (function() {
    ...
    */
    ...
    PersistenceService.$inject = [ '$exceptionHandler', '$window', 'STORAGE_KEY' ];
